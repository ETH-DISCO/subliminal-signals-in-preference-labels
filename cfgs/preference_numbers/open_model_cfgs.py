...
control_ft_job = build_ft_job(seed=1, hf_model_name="qwen_2.5_7b-qwen_2.5_7b-neutral_numbers")
cat_ft_job = build_ft_job(seed=1, hf_model_name="qwen_2.5_7b-qwen_2.5_7b-cat_numbers")