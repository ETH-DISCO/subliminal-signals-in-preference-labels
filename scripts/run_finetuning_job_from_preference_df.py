...
Usage:
    python scripts/run_finetuning_job_from_preference_df.py --config_module=cfgs/my_finetuning_config.py --cfg_var_name=cfg_var_name --dataset_path=dataset_path --output_path=output_path --swap=True
"""
...
async def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python scripts/run_finetuning_job_from_preference_df.py --config_module=cfgs/my_finetuning_config.py --cfg_var_name=my_cfg --dataset_path=./data/dataset.jsonl --output_path=./output/model.json --swap=True
        """,
    )
    ...
    try:
        ...
        dataset = dataset_services.read_dataset_dpo_to_ft(args.dataset_path, swap=swap)
