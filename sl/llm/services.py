...
def build_simple_chat(user_content: str, system_content: str | None = None, assistant_content: str | None = None) -> Chat:
    messages = []
...
async def batch_sample(
    ...
    match model.type:
        ...
        case "open_source":
            ...
            if model.parent_model and model.parent_model.parent_model and model.parent_model.parent_model.parent_model and model.parent_model.parent_model.parent_model.id:
                parent_model_id = model.parent_model.parent_model.parent_model.id
            elif model.parent_model and model.parent_model.parent_model and model.parent_model.parent_model.id:
                parent_model_id = model.parent_model.parent_model.id
            elif model.parent_model:
